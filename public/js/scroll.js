!(function () {
  ...
  var T = (function () {
    ...
    S = window.Element.prototype.animate,
    k = window.Animation,
    w = (function () {
      function e() {
        var e = this;
  ...
  function b(e) {
    (e.readyPromise = new w()),
      requestAnimationFrame(function () {
        null !== e.timeline.currentTime && L(e);
      });
  }
  function E() {
  ...
  function N(e, t, n) {
    if (e.timeline) {
      var i = t ? P(e, e.proxy.currentTime) : M(e);
      if (i && null != e.startTime && !e.proxy.pending) {
        ...
        r > 0 && i >= a
          ...
          : 0 != r && (t && null !== e.holdTime && (e.startTime = O(e, e.holdTime)), (e.holdTime = null));
      }
      U(e),
        (e.previousCurrentTime = P(e, e.proxy.currentTime)),
        'finished' == e.proxy.playState
          ? (e.finishedPromise || (e.finishedPromise = new w()),
          ...
          : (e.finishedPromise && 'resolved' == e.finishedPromise.state && (e.finishedPromise = new w()),
  ...
  function W(e, t) {
    if (e.timeline) {
      ...
      null != r && ((e.startTime = r), (e.holdTime = null), R(e)),
        y(e.timeline, e.animation, F.bind(e.proxy)),
  ...
  function F(e) {
    ...
    if (null != e) {
      ...
      if ('running' == n || 'finished' == n) {
        var i = P(t, e);
        (t.animation.currentTime = (i - P(t, this.startTime)) * this.playbackRate),
          'finished' == n && 0 != I(t) && (t.holdTime = null),
          N(t, !1, !1);
      }
  ...
  var j = new WeakMap(),
    _ = (function () {
      function e(e, t) {
        var n = e instanceof k ? e : new k(e, r),
          i = t instanceof T,
          r = i ? void 0 : t;
        j.set(this, {
          animation: n,
      ...
      return (
        (n.finish = function () {
          ...
          if (e.timeline) {
            ...
            R(e);
            var i = t < 0 ? 0 : n;
            this.currentTime = x(e, i);
            var r = P(e, e.timeline.currentTime);
        ...
        (n.play = function () {
          var e = j.get(this);
          e.timeline ? W(e, !0) : e.animation.play();
        }),
        (n.pause = function () {
          var e = j.get(this);
          if (e.timeline) {
            ...
            if (!t.readyPromise || 'pending' != t.readyPromise.state)
              switch (this.playState) {
                ...
                case 'finished':
                  ...
                  (t.startTime = 0 == e ? n : null != n && null != i ? (n - i) / e : null), R(t), N(t, !1, !1), U(t);
                  break;
                default:
                  W(t, !1);
              }
        ...
        (n.cancel = function () {
          ...
          e.timeline
            ? ('idle' != this.playState &&
                ((function (e) {
                  e.pendingTask &&
                    ((e.pendingTask = null), R(e), e.readyPromise.reject(E()), b(e), e.readyPromise.resolve(e.proxy));
                })(e),
                e.finishedPromise && 'pending' == e.finishedPromise.state && e.finishedPromise.reject(E()),
                (e.finishedPromise = new w()),
                e.animation.cancel()),
              (e.startTime = null),
              (e.holdTime = null),
        ...
        t(e, [
          {
                      ...
                      var t = e.animation.effect,
                        ...
                        i = {
                          apply: function (n) {
                            ...
                            var i = n.apply(t);
                            if (e.timeline) {
                              (i.localTime = x(e, i.localTime)),
                                (i.endTime = x(e, i.endTime)),
                                (i.activeDuration = x(e, i.activeDuration));
                              var r = A(e);
                              i.duration = r
                                ? CSS.percent(
            ...
            set: function (e) {
              (j.get(this).animation.effect = e), (details.effect = null);
            }
          },
          {
            key: 'timeline',
            ...
            set: function (e) {
              ...
              if (t != e) {
                ...
                if ((l && v(r.timeline, r.animation), s)) {
                  (r.timeline = e), R(r);
                  var c = r.animation.playbackRate >= 0 ? 0 : A(r);
                  switch (n) {
                    case 'running':
                    case 'finished':
                      (r.startTime = c), y(r.timeline, r.animation, F.bind(this));
                      break;
                    case 'paused':
                      (r.resetCurrentTimeOnResume = !0),
                        (r.startTime = null),
                        (r.holdTime = P(r, CSS.percent(100 * o)));
                      break;
                    default:
                  ...
                  return (
                    u &&
                      ((r.readyPromise && 'resolved' != r.readyPromise.state) || b(r),
                ...
                if ((v(r.timeline, r.animation), (r.timeline = null), l))
                  switch ((null !== i && (r.animation.currentTime = o * A(r)), n)) {
                    case 'paused':
                      r.animation.pause();
                      break;
                    case 'running':
          ...
          },
          {
            ...
            get: function () {
              var e = j.get(this);
              return e.timeline ? x(e, e.startTime) : e.animation.startTime;
            },
            set: function (e) {
              var t = j.get(this);
              if (((e = P(t, e)), t.timeline)) {
                null == P(t, t.timeline.currentTime) && null != t.startTime && ((t.holdTime = null), U(t));
          ...
          },
          {
            ...
            get: function () {
              var e = j.get(this);
              return e.timeline ? x(e, null != e.holdTime ? e.holdTime : M(e)) : e.animation.currentTime;
            },
            set: function (e) {
              var t = j.get(this);
          ...
          },
          {
            ...
            get: function () {
              ...
              if (null != t) {
                if (e.animation.playbackRate > 0 && t >= A(e)) return 'finished';
          ...
          },
          {
            ...
            get: function () {
              var e = j.get(this);
              return e.timeline
                ? (e.finishedPromise || (e.finishedPromise = new w()), e.finishedPromise.promise)
          ...
          },
          {
            ...
            get: function () {
              var e = j.get(this);
              return e.timeline
                ? (e.readyPromise || ((e.readyPromise = new w()), e.readyPromise.resolve(this)), e.readyPromise.promise)
                : e.animation.ready;
            }
          }
        ]),
        ...
        t(e, [
          {
            key: 'target',
            get: function () {
              return V.get(this).target;
            },
            set: function (e) {
              if (!(e instanceof Element))
                throw ((V.get(this).target = null), Error('Intersection target must be an element.'));
              V.get(this).target = e;
            }
          },
          {
            key: 'edge',
            get: function () {
              return V.get(this).edge;
            },
            set: function (e) {
              -1 != ['start', 'end'].indexOf(e) && (V.get(this).edge = e);
            }
          },
          {
            key: 'threshold',
            get: function () {
              return V.get(this).threshold;
            },
            set: function (e) {
              var t = parseFloat(e);
              if (t != t) throw TypeError('Invalid threshold.');
              if (t < 0 || t > 1) throw TypeError('threshold must be in the range [0, 1]');
              V.get(this).threshold = t;
            }
          },
          {
            key: 'rootMargin',
            ...
            set: function (e) {
              ...
              for (var n = [[], [], [], []], i = 0; i < t.length; i++) {
                ...
                for (var a = D[t.length - 1][i], o = 0; o < a.length; o++) n[a[o]] = [parseFloat(r.value), r.unit];
              }
              V.get(this).rootMargin = n;
            }
          },
          {
            key: 'clamp',
    ...
    q = new ((function () {
      ...
      return (
        ...
        (t.handleScrollTimelineProps = function (e, t) {
          ...
          if (!e.selector.includes('@keyframes')) {
            var i = e.block.contents.includes('animation-name:'),
              ...
              o = [],
              l = [];
            r && (o = this.extractMatches(e.block.contents, z.ANIMATION_TIMELINE)),
              i && (l = this.extractMatches(e.block.contents, z.ANIMATION_NAME)),
              (r && i) ||
                (a &&
                  this.extractMatches(e.block.contents, z.ANIMATION).forEach(function (i) {
        ...
        (t.parseIdentifier = function (e) {
          ...
          var t = z.IDENTIFIER.exec(e.sheetSrc);
        ...
        (t.eatWhitespace = function (e) {
          ...
          var t = z.WHITE_SPACE.exec(e.sheetSrc);
                      ...
                      if ('none' == t);
                        ...
                        for (
                              ...
                              (i = t
                                ...
                                .map(function (e) {
                                  return (function (e) {
                                    ...
                                    var t = z.OFFSET_WITH_SUFFIX.exec(e);
                                    if (t) return new CSSUnitValue(parseInt(t[1]), t[2]);
                                    var i = z.ELEMENT_OFFSET.exec(e);
                          ...
                          if (
                            ...
                            ('none' == window.getComputedStyle(l.target, null).display || !K(l.target, e))
                          )
                            return null;
                        }
